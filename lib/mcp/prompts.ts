      ...
      messages: [
        {
          ...
          content: {
            ...
            text: [
              ...
              "",
              "Show me each variation's COPY IN FULL, as it would be posted, with its creative underneath it — then its character counts and BOTH scores. Do not answer with a table of numbers and leave the writing out; the ads are the thing being made.",
              "",
              "Originality and fidelity are opposite axes and a clone has to be high on both: a high originality score alone can mean you wrote a good ad that is not a clone of this one. Say plainly if anything could not be made to pass.",
            ].join("\n"),
          },
        },
      ],
